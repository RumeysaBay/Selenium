...
public class BrowserUtil {
    // We use BrowserUtil class for initialeze our driver
    ...
    public static void rightclick(WebElement rightClcik,WebDriver driver){
        Actions action=new Actions(driver);
        action.contextClick(rightClcik).perform();
